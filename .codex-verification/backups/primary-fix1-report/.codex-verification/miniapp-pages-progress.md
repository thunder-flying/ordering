...
Primary pages batch: complete (3 models, 3 native pages, 3 reusable components; targeted 4 files / 17 tests and full 12 files / 45 tests passing; typecheck clean; first three page quartets complete; prohibited transactional copy scan clean)
