...
Primary pages batch: GREEN-ready (3 models, 3 native pages, 3 reusable components; targeted verification 4 files / 17 tests passing). Apply the recorded `app.wxss` and `dish-card` replacements before final typecheck.
